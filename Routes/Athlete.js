...
import { Subscribe ,getWorkouts,completeWorkout,getProfile,listAthletes,adminDeleteAthlete,changeAthleteStatus,getExpiredWorkouts,getExpiredCoachCalendars } from "../Controller/AtheleteController.js";
...
AthleteRouter.put("/:athleteId/change-status", auth, checkRole("admin"), changeAthleteStatus);
...
// List expired subscriptions grouped by coach (no calendar payload)
AthleteRouter.get("/expired-workouts", auth, checkRole("athlete"), getExpiredWorkouts);
// Calendars + subscription details for one coach
AthleteRouter.get("/expired-workouts/:coachId", auth, checkRole("athlete"), getExpiredCoachCalendars);
//complete Workout
